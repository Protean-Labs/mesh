...
let test_cases = [
  ...
  ("[];",                     Expr(EList([]))),
  ("[1,2];",                  Expr(EList([Int(1),Int(2)]))),
  ("[\"hello\",\"world\"];",  Expr(EList([String("hello"),String("world")]))),
  ("();",                     Expr(ETuple([]))),
  ...
  ("let x = [];",                     Let("x", EList([]))),
  ("let x = [1,2];",                  Let("x", EList([Int(1),Int(2)]))),
  ("let x = [\"hello\",\"world\"];",  Let("x", EList([String("hello"),String("world")]))),
  ("let x = ();",                     Let("x", ETuple([]))),
